...
<body>
    <div align="center">
        ...
        <c:if test="${isPermissionAccess.permissionCreate == 'Y'}">
        ...
        <br/><br/>
        <h3>Permission</h3>
        <form:form action="permissionSearch" method="post" modelAttribute="permissionSearch">
            <table border="0" cellpadding="6">
                <tr>
                    <td>
                        <form:textarea path="permissionId" placeholder="Enter Permission Id"/>
                    </td>

                    <td>
                        <form:textarea path="permissionUuid" placeholder="Enter Permission Uuid"/>
                    </td>

                    <td>
                        <form:textarea path="permissionName" placeholder="Enter Permission Name"/>
                    </td>
                    <td>
                        <form:textarea path="permissionDesc" placeholder="Enter Permission Desc"/>
                    </td>
                    <td>
                        <form:textarea path="permissionResourceId" placeholder="Enter PermissionResourceId"/>
                    </td>
                    <td>
                        <form:textarea path="permissionResourceUuid" placeholder="Enter PermissionResourceUuid"/>
                    </td>
                    <td>Created Date: </td>
                    <td>
            ...
            <tbody>
                 <c:forEach items="${permissionList}" var="permission">
                    <tr>
                        ...
                        <td>
                            <c:if test="${isPermissionAccess.permissionUpdate == 'Y'}">
                                <a href="/permissionEdit/${permission.permissionUuid}">Edit</a>
                            </c:if>
                            &nbsp;&nbsp;&nbsp;
                            <c:if test="${isPermissionAccess.permissionSoftDelete == 'Y'}">
