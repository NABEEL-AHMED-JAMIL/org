...
<body>
    <div align="center">
        ...
        <c:if test="${isPermissionResourceModuleAccess.permissionCreate == 'Y'}">
        ...
        <form:form action="permissionResourceModuleSearch" method="post" modelAttribute="permissionResourceModuleSearch">
            <table border="0" cellpadding="6">
                <tr>
                    <td>
                        <form:textarea path="permissionResourceModuleId" placeholder="Enter PermissionResourceModule Id"/>
                    </td>
                    <td>
                        <form:textarea path="permissionResourceModuleUuid" placeholder="Enter PermissionResourceModule Uuid"/>
                    </td>
                    <td>
                        <form:textarea path="permissionResourceModuleName" placeholder="Enter permissionResourceModule Name"/>
                    </td>
                    <td>
                        <form:textarea path="permissionResourceModuleDesc" placeholder="Enter PermissionResourceModule Desc"/>
                    </td>
                    <td>
                        <form:textarea path="permissionResourceModuleResourceUuid" placeholder="Enter PermissionResourceModuleResource Uuid"/>
                    </td>
                    <td>Created Date: </td>
                    <td>
            ...
            <tbody>
                 <c:forEach items="${permissionResourceModuleList}" var="permissionResourceModule">
                    <tr>
                        ...
                        <td>
                            <c:if test="${isPermissionResourceModuleAccess.permissionUpdate == 'Y'}">
                                <a href="/permissionResourceModuleEdit/${permissionResourceModule.permissionResourceModuleUuid}">Edit</a>
                            </c:if>
                            &nbsp;&nbsp;&nbsp;
                            <c:if test="${isPermissionResourceModuleAccess.permissionSoftDelete == 'Y'}">
